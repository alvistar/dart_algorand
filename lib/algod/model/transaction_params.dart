...
abstract class TransactionParams implements Built<TransactionParams, TransactionParamsBuilder> {
    ...
    factory TransactionParams([updates(TransactionParamsBuilder b)]) = _$TransactionParams;
    static Serializer<TransactionParams> get serializer => _$transactionParamsSerializer;
